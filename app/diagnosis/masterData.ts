...
export const dentureFrameData = (result: Result): TableRow[] => {
	...
	return [
		...
		{ title: "26. DPO [Distance-mm]", average: "No Norm", deviation: "No Norm", change8To16: -0.18, measurement: dpo, interpretation: Interpretation.Normal },
		{ title: "27. Angle of Condylar path VS Occ. plane", average: "No Norm", deviation: "No Norm", change8To16: -0.18, measurement: angleOfCondylarPathVSOccPlane, interpretation: Interpretation.Normal }
	]
};
